...
%readmore`.trimStart(),
  ...
  footer: '✧»»»»»»»»»»𓃗««««««««««✧\n',
  after: `
© KRIZSERBy Krishnadas
${'```© KRIZSERAdalah Bot Whatsapp Ringan```'}
`,
}
...
⛧ Database: ${rtotalreg} dari ${totalreg}`.trim(),
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Made With 💓 By Krishnadas', 'Pemilik Bot', '.owner', 'Donasi', '.donasi', m)
  } catch (e) {
